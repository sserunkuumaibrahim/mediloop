      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Meet the passionate team behind Mediloop, committed to transforming healthcare in Uganda through innovation and collaboration.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-12 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Advisory Board</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {advisors.map((advisor, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-teal-600 font-semibold text-sm mb-2">{advisor.role}</p>
        ...
        <div className="bg-gradient-to-r from-teal-600 to-green-600 rounded-2xl p-12 text-white text-center">
          ...
          <p className="text-xl mb-8">Help us build Uganda's digital health infrastructure and empower millions.</p>
          <a href="/careers" className="bg-white text-teal-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
            View Open Positions
          </a>
        </div>
      </main>
